...
export default function AdminEventDetailPage() {
  ...
  if (showLoading) {
    return (
      <AdminShell>
        <div className="max-w-4xl mx-auto admin-card p-8 text-center text-[#8B9CB0] text-sm">
      ...
      <div className="max-w-4xl mx-auto space-y-5 text-right">
        ...
        <div className="admin-row items-start justify-between">
          <div className="admin-col">
            <h1 className="text-2xl font-black text-[#F2F6FA]">{event.title}</h1>
            <p className="text-sm text-[#8B9CB0] mt-1">الحالة: {status}</p>
          </div>
        ...
        <div className="admin-card p-5 space-y-3">
          <h2 className="font-black text-[#F2F6FA]">الناشر</h2>
          <div className="text-sm space-y-1">
            ...
            {'userPhoneNumber' in detail && detail.userPhoneNumber && (
              <div dir="ltr" className="text-left font-mono text-[#8B9CB0]">
        ...
        <div className="admin-card p-5 space-y-3">
          <h2 className="font-black text-[#F2F6FA] flex items-center gap-2">
            <MapPin className="w-4 h-4 text-[#1F6B7A]" />
            موقع النشر بالظبط
          </h2>
          <p className="text-sm text-[#F2F6FA] font-semibold">{locationLabel}</p>
          {detail.latitude != null && detail.longitude != null ? (
            <div className="space-y-3">
              <div className="text-xs text-[#8B9CB0] font-mono" dir="ltr">
        ...
        <div className="admin-card overflow-visible">
          <div className="p-5 space-y-3">
            <h2 className="font-black text-[#F2F6FA]">المحتوى</h2>
            <p className="text-sm text-[#A8B8C8] whitespace-pre-wrap leading-relaxed">{event.description}</p>
          </div>
          ...
          <div className="px-5 py-3 admin-row justify-between text-xs text-[#8B9CB0] border-t border-[rgba(15,27,45,0.06)]">
          ...
          <div className="mx-4 mb-4 grid grid-cols-3 gap-1 border-t border-[rgba(15,27,45,0.06)] pt-2">
            ...
            <div className="flex justify-center">
              <button
                type="button"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-slate-600 hover:bg-slate-50 border border-[rgba(45,138,156,0.28)]"
                onClick={() => {
